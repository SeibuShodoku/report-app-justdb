...
import { listReportVersions } from "@/lib/prevention-report-store";
import { authorizeFolderAccess } from "@/lib/security/proxy-auth";

export const runtime = "nodejs";

/**
 * 防除作業報告書の版一覧を返す（新しい版が先頭）。版ディレクトリが無ければ空配列。
 * 例: GET /api/prevention-report/versions?folderId=DIR&token=...
 */
