import { deleteReportVersion } from "@/lib/prevention-report-store";
...
/**
 * 版を削除する＝Drive ゴミ箱へ（復元可・物理削除しない）。**最新版は削除不可**・**作成者本人のみ**。
 * 例: POST /api/prevention-report/delete?folderId=DIR&token=...  body={ version: 2 }
 */
